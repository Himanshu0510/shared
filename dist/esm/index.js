            ...
            React.createElement("div", null,
                React.createElement("div", { className: "modal-content" },
                    React.createElement("h4", null,
                        "Filter:",
                        " ",
                        React.createElement(Checkbox, { onChange: () => this.setState({ filter: !this.state.filter }), checked: this.state.filter })),
                ...
                React.createElement("div", { className: "p-dialog-footer" },
                    React.createElement(Button, { className: "btnStyle btn btn-success", onClick: () => this.handleChange(), autoFocus: true }, "Save"),
                    React.createElement(Button, { className: "btnStyle btn btn-info", onClick: () => this.resetSettings() }, "Reset"),
                    React.createElement(Button, { className: "btnStyle btn btn-danger", onClick: () => this.handleCancel() }, "Cancel")))));
    }
}
...
class Table extends react.exports.Component {
    render() {
        return (React.createElement(React.Fragment, null,
            ...
            React.createElement(DataTable, { value: this.props.data, tableStyle: { minWidth: "50rem" } },
